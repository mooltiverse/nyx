...
var (
	...
	*/
	wellKnownValidConventionalCommitsMessages = []struct {
		...
		{message: utl.PointerToString("feat(shopping cart-with_dash_and_underscore): add the amazing button"), returnedType: utl.PointerToString("feat"), scope: utl.PointerToString("shopping cart-with_dash_and_underscore"), title: utl.PointerToString("add the amazing button"), bump: utl.PointerToString("minor")},
	...
	*/
	...
	wellKnownValidConventionalCommitsForMergeMessages = append(wellKnownValidConventionalCommitsMessages, []struct {
		...
		//{message: utl.PointerToString("Anything\n\nfeat(shopping cart-with_dash_and_underscore): add the amazing button"), returnedType: utl.PointerToString("feat"), scope: utl.PointerToString("shopping cart-with_dash_and_underscore"), title: utl.PointerToString("add the amazing button"), bump: utl.PointerToString("minor")},
