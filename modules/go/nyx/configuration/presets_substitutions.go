...
var (
	...
	EXPO_VERSION = ent.NewSubstitutionWith(utl.PointerToString("@(app.json|app.config.json)"), utl.PointerToString("\"version\"(\\s)*:(\\s)*\"(0|[1-9]\\d*)\\.(0|[1-9]\\d*)\\.(0|[1-9]\\d*)(?:-((?:0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\\.(?:0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\\+([0-9a-zA-Z-]+(?:\\.[0-9a-zA-Z-]+)*))?\""), utl.PointerToString("\"version\": \"{{version}}\""))
	...
	TEXT_VERSION = ent.NewSubstitutionWith(utl.PointerToString("version.txt"), utl.PointerToString(".*"), utl.PointerToString("{{version}}"))
)
