...
func TestReleaseTypeNewReleasesTypeWith(t *testing.T) {
	...
	releaseType := NewReleaseTypeWith(nil, utl.PointerToBoolean(true), utl.PointerToString("{{#sanitizeLower}}{{branch}}{{/sanitizeLower}}"), utl.PointerToString("Release description"), utl.PointerToString("^({{configuration.releasePrefix}})?([0-9]\\d*)\\.([0-9]\\d*)\\.([0-9]\\d*)$"), utl.PointerToString("true"), utl.PointerToString("Committing {{version}}"), utl.PointerToString("true"), utl.PointerToString("true"), utl.PointerToString("Tagging {{version}}"), &identifiers, utl.PointerToString(""), &matchEnvironmentVariables, nil, utl.PointerToString("true"), utl.PointerToString(""), utl.PointerToBoolean(false))
