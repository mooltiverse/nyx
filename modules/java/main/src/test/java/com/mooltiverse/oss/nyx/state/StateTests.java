...
public class StateTests {
    ...
    class AttributesTests {
        ...
        void getNewReleaseTest()
            ...
            state.setReleaseType(new ReleaseType(null, true, null, null, null, Boolean.FALSE.toString(), null, Boolean.FALSE.toString(), Boolean.FALSE.toString(), null, List.<String>of(), null, null, null, null, /*this is the 'publish' flag -> */ Boolean.TRUE.toString(), null, null, Boolean.FALSE));
            state.setVersion("1.2.3");
            ...
            state.setReleaseType(new ReleaseType(null, true, null, null, null, Boolean.FALSE.toString(), null, Boolean.FALSE.toString(), Boolean.FALSE.toString(), null, List.<String>of(), null, null, null, null, /*this is the 'publish' flag -> */ Boolean.FALSE.toString(), null, null, Boolean.FALSE));
