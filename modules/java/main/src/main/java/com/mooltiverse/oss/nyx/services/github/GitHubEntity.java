...
abstract class GitHubEntity {
     ...
     * @throws IllegalArgumentException if the map of attributes is empty. Can't be {@code null}
     */
    protected GitHubEntity(API api, Map<String, Object> attributes) {
        super();
     ...
     * 
     * @return the map of attributes this object is bbyuiltuilt on
     */
