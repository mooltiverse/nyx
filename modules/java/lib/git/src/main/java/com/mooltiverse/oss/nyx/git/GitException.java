...
/**
 * A generic Git exception class. This class is abstract so all actual exceptions must use more meaningful inherited specializations.
 */
public abstract class GitException extends Exception {
     ...
     * @param cause the cause
     */
    protected GitException(Throwable cause) {
        super(cause);
    }
}