 ...
 * the two must not be confused. This class is meant to map configuraion values to version {@link com.mooltiverse.oss.nyx.version.Scheme}.
 * 
...
public enum Scheme {
    ...
    /**
     * The scheme value used in configuration.
     */
