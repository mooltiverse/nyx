...
public class ArrangeTestTemplates {
    ...
    public static class ConstructorTests {
        ...
        void constructorTest(@CommandSelector(Commands.ARRANGE) CommandProxy command)
            throws Exception {
    ...
    public static class StateTests {
        ...
        @DisplayName("Arrange.state()")
        @Baseline(Scenario.FROM_SCRATCH)
        void stateTest(@CommandSelector(Commands.ARRANGE) CommandProxy command)
            throws Exception {
    ...
    public static class UpToDateTests {
        ...
        void isUpToDateTest(@CommandSelector(Commands.ARRANGE) CommandProxy command)
            throws Exception {
