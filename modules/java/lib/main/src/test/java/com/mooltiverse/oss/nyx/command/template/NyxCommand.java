 ...
 * using the {@link Nyx} class as if it was standalone.
 */
class NyxCommand implements Command {
    ...
    /**
     * The method to be invoked by this class.
     */
     ...
     * @param command the command to run when the {@link #run()} methos is invoked.
     * 
