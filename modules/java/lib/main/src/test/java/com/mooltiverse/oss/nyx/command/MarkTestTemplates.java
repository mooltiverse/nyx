...
public class MarkTestTemplates {
    ...
    public static class RunTests {
        ...
        @TestTemplate
        @DisplayName("Mark.run() on a clean workspace using a release type with Commit, Tag and Push enabled after Infer has generated a new Version > yield to no new commit but a new tag, with changes pushed to remote")
        @Baseline(Scenario.ONE_BRANCH_SHORT)
