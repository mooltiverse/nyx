...
public class ReleaseType {
     ...
     */
    private Identifiers identifiers = Defaults.ReleaseType.IDENTIFIERS;
     ...
     * @param identifiers the optional map of the custom extra identifiers to be used in a
     * release type.
     ...
     */
    public ReleaseType(boolean collapseVersions, String collapsedVersionQualifier, String filterTags, String gitCommit, String gitCommitMessage, String gitPush, String gitTag, String gitTagMessage, Identifiers identifiers, String matchBranches, Map<String,String> matchEnvironmentVariables, WorkspaceStatus matchWorkspaceStatus, String publish, String versionRange, Boolean versionRangeFromBranchName) {
        super();
     ...
     * 
     * @return the identifiers configuration block. It may be {@code null}.
     */
     ...
     * 
     * @param identifiers the identifiers configuration block. It may be {@code null}.
     */
     ...
     * 
     * @return the match environment variables map. May be {@code null}.
     */
     ...
     * 
     * @param matchEnvironmentVariables the match environment variables map. May be {@code null}.
     */
