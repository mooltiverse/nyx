...
public class PublishTaskTests extends CoreTaskTests {
    ...
    class DefineTests {
         ...
         */
        @Test
        @DisplayName("PublishTask.define() -> test eager task creation")
        void defineEagerTest() {
            ...
            assertNotNull(PublishTask.define(project));
         ...
         */
        @Test
        @DisplayName("PublishTask.define() -> test deferred task creation")
        void defineLazyTest() {
            Project project = ProjectBuilder.builder().build();
