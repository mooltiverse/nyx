...
public class ArrangeTestTemplates {
    ...
    static class ConstructorTests extends com.mooltiverse.oss.nyx.command.ArrangeTestTemplates.ConstructorTests {}

    @Nested
    @DisplayName("Arrange state")
    @ExtendWith(GradleCommandInvocationContextProvider.class)
    static class StateTests extends com.mooltiverse.oss.nyx.command.ArrangeTestTemplates.StateTests {}
    ...
    @ExtendWith(GradleCommandInvocationContextProvider.class)
    static class UpToDateTests extends com.mooltiverse.oss.nyx.command.ArrangeTestTemplates.UpToDateTests {}

    @Nested
    @DisplayName("Arrange run")
    @ExtendWith(GradleCommandInvocationContextProvider.class)
    static class RunTests extends com.mooltiverse.oss.nyx.command.ArrangeTestTemplates.RunTests {}

    /**
     * Performs checks on the task business actions.
     */
    @Nested
    @DisplayName("ArrangeTask.Actions.execute")
    @ExtendWith(GradleCommandInvocationContextProvider.class)
    static class ActionTests {
        ...
        void noExceptionOnExecuteWithValidGitRepositoryInCustomDirectoryTest(Project project, @CommandSelector(Commands.ARRANGE) CommandProxy command, Script script)
        throws Exception {
        ...
        @Baseline(Scenario.INITIAL_COMMIT)
        void noExceptionOnExecuteWithValidGitRepositoryInWorkingDirectoryTest(@CommandSelector(Commands.ARRANGE) CommandProxy command)
            throws Exception {
            assertDoesNotThrow(() -> command.run());
        }
    }
