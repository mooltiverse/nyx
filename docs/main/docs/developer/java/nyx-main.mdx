...
You can download the jar file directly from the [GitHub Packages](https://github.com/orgs/mooltiverse/packages) repository.
...
:::info
To use the [GitHub Packages](https://github.com/orgs/mooltiverse/packages) repository you can follow [these instructions](https://help.github.com/en/packages/using-github-packages-with-your-projects-ecosystem/configuring-apache-maven-for-use-with-github-packages).
:::
