...
import {siteVariables} from '@site/src/data/siteVariables';
...
{`<dependency>
    ...
    <version>${siteVariables.version}</version>
</dependency>`}
  </code>
</pre>
...
<pre>
  <code>
{`<dependency org="com.mooltiverse.oss.nyx" name="main" rev="${siteVariables.version}" />`}
  </code>
</pre>
...
<pre>
  <code>
{`implementation 'com.mooltiverse.oss.nyx:main:${siteVariables.version}'`}
  </code>
</pre>
