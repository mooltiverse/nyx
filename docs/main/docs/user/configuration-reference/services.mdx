...
| [`services/<NAME>/options`](#options)                                                      | [map](../introduction/configuration-methods.mdx#collections-of-objects)   `--services-<NAME>-options-<OPTION>=<VALUE>` | `NYX_SERVICES_<NAME>_OPTIONS-<OPTION>=<VALUE>` | Empty                                  |
