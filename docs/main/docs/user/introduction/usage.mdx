...
You can find the latest binaries for any platform in the [latest release](https://mooltiverse.github.io/nyx/releases/latest) assets.
...
Nyx version: ${siteVariables.version}
...
As you can see you can give as much arguments as you like and one command at the end. Arguments start with a single (`-`) or double dash (`--`) and are detailed in the full output from `nyx --help` and in the [configuration reference](../configuration-reference/index.md#configuration-file).
...
* [GitHub Container Registry](https://mooltiverse.github.io/nyx/pkgs/container/nyx)
...
When using GitHub Actions, the [Nyx Action](https://mooltiverse.github.io/nyx-github-action) is the easiest and most effective way of using Nyx.

Please refer to the [action page](https://mooltiverse.github.io/nyx-github-action) for instructions.
