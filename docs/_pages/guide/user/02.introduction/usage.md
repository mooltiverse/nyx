...
* Gradle release `6.0` or later. Tests have been successfully executed up to release `7.3.2`. [Here](https://gradle.org/releases/) you can find the list of available releases.
