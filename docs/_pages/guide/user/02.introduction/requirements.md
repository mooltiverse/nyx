...
The recommended runtime is Java VM `15` or newer and Gradle `7.0` or newer. Tests are conducted up to Java VM `19` and Gradle versions up to `8.0` have been tested.
